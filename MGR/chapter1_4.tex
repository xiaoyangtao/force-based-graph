...
Okazuje siê, ¿e dwiema godnymi rozwa¿enia metodami s¹ wiadomoœci oraz Web
serwisy, bêd¹ce jednym ze sposobów zdalnego wywo³ywania procedur.

 
\paragraph{Zdalne wywo³ywanie procedur - Web serwisy}
Trzeba napisaæ, ¿e mimo, ¿e istnieje kilka ró¿nych standardów RPC, Web serwisy
s¹ jedynym praktycznie stosowanym w przypadku integracji mobilnej.
