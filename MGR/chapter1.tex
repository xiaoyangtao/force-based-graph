...
\section{Zdalne wywo³ywanie procedur - Webserwisy}
[tu coœ trzeba by napisaæ]
...
obs³uguj¹cych kolejki wiadomoœci jest jedn¹ z mo¿liwoœci, obok lekkich
kontenerów jak np. Spring, wybierzemy serwer JBoss jako popularne i
sprawdzone, a jednoczeœnie darmowe rozwi¹zanie implementuj¹ce wszystkie us³ugi
JEE.
