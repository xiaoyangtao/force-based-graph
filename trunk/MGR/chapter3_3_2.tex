...
Nokia. B³êdy te nie uniemo¿liwia³y pracy, jedynie pozostawia³y wra¿enie
...
zapoznanie siê z nieudokumenowanymi funkcjonalnoœciami oraz ewentualne
wprowadzenie w³asnych poprawek.
\newline
Bardzo uci¹¿liwym problemem jest rozmiar skompilowanych bibliotek œrodowiksa
...
ograniczenie rozmiaru pliku jar jak mo¿a za³adowaæ. Najczêœciej ograniczenie to
oscyluje w okolicach 100-150 kilobajtów przez co niemo¿liwe jest wykorzystanie
Kuix na tych platformach. Problem ten dotyczy g³ównie rozwi¹zañ konsumenckich,
gdy¿ w rozwi¹zaniach moblnych dla biznesu ograniczenia s¹ du¿o wy¿sze lub
mo¿liwe jest dzielenie programu na biblioteki(taki rozwi¹zanie mo¿na znaleŸæ n
