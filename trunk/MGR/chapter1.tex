...
lub informacjê o jej niedostarczeniu. Musimy pamiêtaæ, ¿e warunki w jakich mo¿emy komunikowaæ siê z
...
Ze wzglêdu na istotnoœæ dla niniejszej pracy opisowi tej technologii zostanie
poœwiêcony ca³y nastêpny rozdzia³.
...
Pierwsze wzmianki o rozwi¹zaniu pozwalaj¹cym wspó³pracê ró¿norodnych systemów,
poprzez ogólnodostêpne medium pojawi³y siê w okolicach roku 1999. W krótkim czasie zainteresowa³y siê nim
...
podstawie zbudowana dwa podstawowe jêzyki towarzysz¹ce rozwi¹zaniom typu Web
...
Wykorzystanie tego protoko³u jako podstawy Web Service niesie ze sob¹
konsekwencje. SOAP bêd¹c form¹ elektronicznej koperty generujê stosunkowo durzy
narzut danych na ka¿d¹ wysy³an¹ wiadomoœæ, przez co wp³ywa równie¿ na wydajnoœæ
komunikacji przy u¿yciu Web Services. W zwi¹zku ze wspomnian¹ powy¿ej wad¹ nie
...
platforma, gdy¿ generatory wymagaj¹ zwykle wsparcia po stronie urz¹dzenia (na
przyk³ad wymagaj¹ implementacji odpowiedniego profilu).
...
pisanie na urz¹dzenia mobilne musz¹ byæ od razu konfigurowani pod k¹tem obs³ugi
...
z niektórymi rodzajami. W skrajnym przypadku dochodzi tak¿e do ró¿niæ pomiêdzy
wersjami. Taka sytuacja zachodzi na przyk³ad w Apache Axis, który
...
pewno w najbli¿szym czasie nie stanie siê na nich standarde. Ograniczeniem tu
