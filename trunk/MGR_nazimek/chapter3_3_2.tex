...
\begin{figure}[htb]
    ...
    \end{center}
    \caption{G³ówny ekran omawianej aplikacji}
...
dotyczy g³ównie rozwi¹zañ konsumenckich, gdy¿ w rozwi¹zaniach mobilnych dla
biznesu ograniczenia s¹ du¿o mniejsze lub mo¿liwe jest dzielenie programu na
biblioteki (takie rozwi¹zanie mo¿na znaleŸæ na platformie Blackberry).
