...
przysz³oœci przekazywaæ im jedynie interesuj¹ce ich informacje. Ca³a aplikacja oparta jest na przedstawionym wczeœniej szablonie, do którego
...
\ref{fig:phone_processed5}, dotycz¹cych aktualnie ogl¹danej wiadomoœci. Mo¿e
poinformowaæ system, ¿e dana wiadomoœæ go szczególnie zainteresowa³a lub ¿e nie chce wiêcej dostawaæ tego typu wiadomoœci. Na podstawie udzielonych odpowiedzi system
personalizuje listê wysy³anych do danego u¿ytkownika wiadomoœci. Po wybraniu preferencji zostaje natychmiast za³adowany ekran z nastêpn¹
wiadomoœci¹.
...
(istnieje oczywiœcie mo¿liwoœæ dodania w³asnych odpowiedzi, jednak
nasza aplikacja uwzglêdnia tylko te dwie w dalszym
przetwarzaniu).
...
Widzimy g³osy oddane przez u¿ytkownika na okreœlone kategorie oraz bie¿¹c¹
