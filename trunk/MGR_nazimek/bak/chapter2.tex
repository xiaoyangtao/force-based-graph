...
dostêpne na rynku urz¹dzenia, które posiadaj¹ preistalowane systemy operacyjne
...
Po dok³adnym przyj¿eniu siê powy¿szym platformom nasuwa siê jeden stanowczy
wniosek - poza platformamy opartymi na J2ME, wykonianie jednej, spójnej aplikacji
spe³niaj¹cej za³o¿enia interoperacyjnoœci jest praktycznie niemo¿liwe. Jedynym
rozwi¹zaniem jest przygotowanie kilku instancji tej samej aplikacji, które
niestety nie bêd¹ mia³y ze sob¹ niczego wspólnego poza przyjêtymi za³o¿eniami o
podstawowej funkcjonalnoœci. Wynika to miêdzy innymi z tego, ¿e ka¿da plaforma
oferuje inne mo¿liwoœci i przy okazji wprowadza inne ograniczenia. Co wiêcej tego
typu ró¿nicowanie wystepujê równie¿ w obrêbie samych plaftorm. Na przyk³ad J2ME
...
próg wejœcia oraz utrudnia poprawn¹ kontrolê nad stopniem doj¿a³oœci produktu. Co
wiêcej przy s³abym zarz¹dzaniu funkcjonalnoœciami mo¿e wyst¹piæ problem
zró¿nicowania pomiêdzy ró¿nymi wersjami naszej aplikacji. Tego typu problemy
...
stosowane s¹ rózne rozwi¹zania mobilne. W wypadku naszego systemu integracyjnego
...
Blackberry, która jest stworzona w³asnie w oparciu o ten standard jest jedn¹ z
najbardziej popularnych, w firmach, które chc¹ podj¹æ dzia³ania maj¹ce na celu
umobilnienie, wystêpuj¹chych w ich obrêbie, procesów biznesowych.

\section{Jak siê do tego zabraæ ?}

W momencie gdy mamy ustalon¹ ju¿ platformê docelow¹ (J2ME) musimy przyj¿eæ siê,
...
na wymianê czystych nie przetworzonych danych binarnych, czy te¿ tesktowych.
Mo¿na je wykorzystaæ w sposób bezpoœredni, jednak jest to niezwykle trudne i
...
wygodn¹ i ³atw¹ do przeœledzenia komunikacje z systemami zewnêtrznymi.
