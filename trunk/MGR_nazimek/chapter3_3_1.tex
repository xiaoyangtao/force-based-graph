...
\begin{figure}[htb]
    \begin{center}
    \includegraphics[angle=0,scale=0.8]{img/pool_schema_o.png}
    \end{center}
...
Schemat koncepcyjny(rysunek \ref{fig:pool_db}) jest tylko przyk³adem, który ma
byæ podstaw¹ do prezentacji mo¿liwoœci szkieltu Kuix. Konstrukcja tego schematu mo¿e byæ
dowolna. Kluczowym zagadnieniem jest transformacja danych zawartych w systemie
na XML, który reprezentuje interfejs widoczny na urz¹dzeniu. Kuix jest na
tyle elastyczny, ¿e mo¿liwe jest pod³¹czenie do niego dowolnego Ÿród³a danych,
które mo¿e generowaæ XML (w szczególnoœci nie musi to byæ baza relacyjna -
