...
\newline
Dane zosta³y podzielone na 5 czêœci w taki sposób, ¿e 80\% stanowi zbiór
trenuj¹cy, a pozosta³e 20\% to zbiór testowy (przy czym zbiory testowe s¹
...
W miarê przeprowadzania testów zostanie podjêta decyzja o rodzaju algorytmu 
Slope One, który bêdzie wykorzystywany. Pod uwagê zostan¹ wziête dwa jego
rodzaje: zwyk³y (taki jak opisany wy¿ej) oraz Bi-Polar Slope One. Ten druga
wprowadza modyfikacjê do ocen dziel¹c je na dwie kategorie : oceny dobre i
oceny z³e. Ze wzglêdu na asymetriê ocen wystêpuj¹cych w zbiorach testowych (70%
ocen jest pozytywnych, czyli powy¿ej œredniej) podzia³ bêdzie wykonany w sposób
nastêpuj¹cy : ocena dobra (3,4,5), ocena z³a (1,2). Zostan¹ im przyporz¹dkowane
