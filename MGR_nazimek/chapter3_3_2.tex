...
do czynienia z raz zdefinowanym przez programistê uk³adem oraz wygl¹dem
...
kodzie Ÿród³owym aplikacji redeneruj¹cej, dziêki czemu, w zale¿noœci od
...
Na poni¿szym obrazku widoczn¹ jest struktura bardzo prostego programu,
...
wczytywanie jest bardzo proste i w pewnien sposób przypomina tworzenie
...
By za³adowaæ do systemu plik CSS, znajudj¹cy siê w zasobach projektu, nale¿y
...
Najbardziej aktualna wersja 1.01 posiada nadal du¿o wad i b³êdów. Z wykonanych
...
zapoznanie siê z nieudokumentowanymi funkcjonalnoœciami oraz ewentualne
wprowadzenie w³asnych poprawek.
\newline
Bardzo uci¹¿liwym problemem jest rozmiar skompilowanych bibliotek œrodowiska
Kuix. Na chwilê obecn¹ jest to oko³o 250 kilobajtów. Wiele œrodowisk Javy,
spotykanych na platformach mobilnych, posiada sta³e, nadane przez producenta
ograniczenie rozmiaru pliku jar, jaki mo¿e za³adowaæ. Najczêœciej ograniczenie
to oscyluje w okolicach 100-150 kilobajtów, przez co niemo¿liwe jest
wykorzystanie Kuix na tych platformach. Problem ten dotyczy g³ównie rozwi¹zañ konsumenckich,
gdy¿ w rozwi¹zaniach mobilnych dla biznesu ograniczenia s¹ du¿o wy¿sze lub
mo¿liwe jest dzielenie programu na biblioteki(takie rozwi¹zanie mo¿na znaleŸæ na
