...
{  
    ...
    /Title ()
    /Subject (Integracja systemów mobilnych) 
...
%\usepackage{multibib}
%\newcites{bk,st,doc,web}{Ksi¹¿ki i~artyku³y,Standardy i~zalecenia,Dokumentacja produktów,Publikacje i~serwisy internetowe}
...
% kody Ÿród³owe wplatane w tekst
