...
które pozwoli³yby na dostêp do bazy danych z poziomu urz¹dzenia mobilnego, ponownie
spotkalibyœmy siê z problemem zawodnej komunikacji.\\
Okazuje siê, ¿e dwie, godne rozwa¿enia metody stanowi¹, z jednej strony,
wiadomoœci,a z drugiej - Web serwisy, bêd¹ce jednym ze sposobów zdalnego
...
protokó³ HTTP czy jêzyk XML. Daje to nam gwarancjê na to, ¿e nie ma znaczenia w
...
\begin{figure}[htb]
    ...
    \end{center}
    \caption{Trzy podstawowe elementy zwi¹zane Web Services}
...
formaty certyfikacyjne takie jak X.509. Protokó³ dzia³a w warstwie aplikacyjnej i zosta³
tak zaprojektowany, by zapewniæ bezpieczeñstwo od koñca do koñca (end-to-end
...
\end{itemize}
Nie jest to, oczywiœcie, technologia pozbawiona wad. To, co musimy wzi¹æ pod
...
Windows Mobile, maj¹ swoje w³asne rozwi¹zania. Warto zwróciæ uwagê na
...
zarówno w ten sposób, jak i za pomoc¹ wiadomoœci tekstowych. Pozwala to na
